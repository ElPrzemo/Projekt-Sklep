...
//    @Test
//    void testEquals() {
//        when(parent.getId()).thenReturn(Long.valueOf(1));
//        when(parent.getName()).thenReturn("getNameResponse");
//        when(parent.getParent()).thenReturn(new CategoryTree(Long.valueOf(1), "name", Long.valueOf(1)));
//        when(parent.getChildren()).thenReturn(List.of(new CategoryTree(Long.valueOf(1), "name", Long.valueOf(1))));
//        when(parent.canEqual(any())).thenReturn(true);
//
//        boolean result = categoryTree.equals("o");
//        Assertions.assertEquals(true, result);
//    }
//
//    @Test
//    void testCanEqual() {
//        boolean result = categoryTree.canEqual("other");
//        Assertions.assertEquals(true, result);
//    }
//
//    @Test
...
//        when(parent.getChildren()).thenReturn(List.of(new CategoryTree(Long.valueOf(1), "name", Long.valueOf(1))));
//
//        int result = categoryTree.hashCode();
...
//        when(parent.getChildren()).thenReturn(List.of(new CategoryTree(Long.valueOf(1), "name", Long.valueOf(1))));
//
//        String result = categoryTree.toString();
